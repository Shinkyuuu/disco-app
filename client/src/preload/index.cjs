...
contextBridge.exposeInMainWorld('api', {
  ...
  pickFrameSourceImages: () => ipcRenderer.invoke('pick-frame-source-images'),
  saveDefaultFramesAvatar: (slotIndex, frameFilePaths, fps) => ipcRenderer.invoke('save-default-frames-avatar', { slotIndex, frameFilePaths, fps }),
  saveFriendFramesAvatar: (userId, frameFilePaths, fps) => ipcRenderer.invoke('save-friend-frames-avatar', { userId, frameFilePaths, fps }),
  setDefaultAvatarType: (slotIndex, type) => ipcRenderer.invoke('set-default-avatar-type', { slotIndex, type }),
  setFriendAvatarType: (userId, type) => ipcRenderer.invoke('set-friend-avatar-type', { userId, type }),
